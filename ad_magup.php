...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <form action="ad_manageupdb.php" method="post">
      ...
      <b>Email:</b>
      <input type="text" name="Email_Id" maxlength="100"class="form-control" value="<?php echo $list['Pass']; ?>" required/><br>

      <b>Password:</b>
      <input type="password" name="Password" maxlength="100" class="form-control" value="<?php echo $list['Email']; ?>" required/><br>
      <b>Programme:</b>
